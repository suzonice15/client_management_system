...
<head>
  ...
  <title>   User Management Software</title>
      ...
      @if (count($errors) > 0)
              ...
              <ul>
                  @foreach ($errors->all() as $error)
                      ...
                      <h4> <li style="list-style: none;color:red">{{ $error }}</li></h4>
                  @endforeach
              </ul>
          ...
          <h4> <li style="list-style: none;color:red;text-align: center">
          ...
          <h4> <li style="list-style: none;color:deepskyblue;text-align: center">
