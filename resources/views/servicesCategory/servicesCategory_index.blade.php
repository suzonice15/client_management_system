...
<div class="box-header with-border">
    ...
    <a href="{{ route('serviceCatogory.create') }}" class="btn btn-success pull-right"> Add New </a>
</div>
    @endsection
@section('mainContent')
        ...
        <table id="datatable" class="table table-bordered" style="width:100%">
            ...
            <tr>
                ...
                <td>
                    ...
                    <form action="{{ route('serviceCatogory.destroy',$category->service_category_id) }}" method="POST">
                        @csrf
                        @method('DELETE')

                        <a href="{{ route('serviceCatogory.edit',$category->service_category_id) }}"> <span class="glyphicon glyphicon-edit btn btn-success"></span></a>
