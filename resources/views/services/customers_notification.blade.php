                    ...
                    <tr>
                        ...
                        <td>
                            <a  target="_blank" href="{{ url('/customers/notificationView/'.$customer->customer_id) }}"> <span class="glyphicon glyphicon-user btn btn-info"></span></a>
                                ...
                                <a href="{{ url('/customers/notificationEdit/'.$customer->customer_id) }}"> <span class="glyphicon glyphicon-edit btn btn-success"></span></a>
                                <a href="{{ url('/customers/notificationShow/'.$customer->customer_id) }}"> <span class="glyphicon glyphicon-eye-close btn btn-danger"></span></a>
                        </td>
                    </tr>
                @endforeach
                @else
